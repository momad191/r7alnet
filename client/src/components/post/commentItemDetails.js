...
return (
  ...
  <Fragment>
     ...
     <h1 style={{fontFamily:'Markazi Text',fontSize:'40px',textAlign:'right',fontWeight:'bold',color:'#000'}} >  {title} </h1>
    
     <Link to={`/Topic/${_id}`}  style={{fontFamily:'Markazi Text',fontSize:'20px',textAlign:'right',fontWeight:'bold',color:'#000'}} >
       ...
       <div class="portfolio-content-wide ">
        ...
        <div class="col-xs-12 col-sm-8 col-md-8 col-lg-12"  >
           ...
           <Link
            ...
            type='button'
          className="btn btn-success fontnty-font"
            style={{ padding:'20px', cursor: '' ,color:'#fff',backgroundColor:'#2EB67D',fontWeight:'bold',fontSize:'19px',fontFamily:'',textAlign:'center'}}
           
            to={`/Topic/${_id}`} 
          >  
            {/* <i  style={{fontSize:'26px'}} className='far fa-grin-alt'/>   */}
            <i style={{fontSize:'26px'}}className='fas fa-thumbs-up' />
          ...
          <Link
            ...
            className="btn btn-success fontnty-font"
            style={{ padding:'20px', cursor: '' ,color:'#fff',backgroundColor:'#1C1C1C',fontWeight:'bold',fontSize:'19px',fontFamily:'',textAlign:'center'}}

             href={`/posts/${_id}`} 
          >  
           {/* <i  style={{fontSize:'26px'}} className='fa fa-frown'/> */}
          <i style={{fontSize:'26px'}}className='fas fa-thumbs-down' />
          </Link>
          </div>
           
          <h1 style={{fontFamily:'Changa', color:'#000',fontSize:'15px',fontWeight:'bold'}}>
                هل أعجبك القال :
                </h1>
