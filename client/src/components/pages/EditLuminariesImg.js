...
export default class EditLuminariesImg extends Component {
  ...
  onSubmit(e) {
   ...
   axios.post('http://localhost:5000/api/Luminaries/EditLuminariesImg/' + this.props.match.params.id, formData)
  ...
  render() {
   ...
   <h1 className="middle text-primary"><i className="fas fa-star"></i> Edit Luminaries Image </h1>	 
