...
const Exercise = props => (
   ...
   <tr>
    ...
    <td style={activetdStyle}>{props.exercise.department}</td>
...
handlePageClick = (e) => {
  ...
  exerciseList() {
    ...
    .filter(profile=>{
      ...
      return profile.department.toLowerCase().indexOf(this.state.search.toLowerCase())>=0
  ...
  render() {
    ...
    return ( 
      <div>
        ...
        <Link to="/searchMembersBySpecialty" title="Dashboard" className=''><i className="fas fa-search text-primary"></i> <span className="hide-sm text-success">By Specialization </span></Link>--
        ...
        <input  style={inputTextStyle} type='text' placeholder="Type The Specialization" onChange={this.searchChanged} value={this.state.search}/>
