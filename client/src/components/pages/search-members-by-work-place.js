...
(
   ...
   <tr>
    ...
    <td style={activetdStyle}>{props.exercise.company}</td>
...
handlePageClick = (e) => {
  ...
  exerciseList() {
    ...
    .filter(profile=>{
      ...
      return profile.company.toLowerCase().indexOf(this.state.search.toLowerCase())>=0
  ...
  render() {
    ...
    return ( 
      <div>
        ...
        <Link to="/searchMembersByWorkPlace" title="Dashboard" className=''><i className="fas fa-search text-primary"></i> <span className="hide-sm text-success">By Work Place </span></Link>
 

        <input  style={inputTextStyle} type='text' placeholder="Type The Place of Work" onChange={this.searchChanged} value={this.state.search}/>
