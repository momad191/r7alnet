  ...
  render() {
    return (
      <div>
        ...
        <Link to="/searchQuestionByTitle" title="Dashboard" className=''><i className="fas fa-search text-primary"></i> <span className="hide-sm text-dark">By Title </span></Link>--
        <Link to="/searchQuestionByTags" title="Dashboard" className=''><i className="fas fa-search text-primary"></i> <span className="hide-sm text-success">By Tags </span></Link>--
 

        <input  style={inputTextStyle} type='text' placeholder="Search By Tags " onChange={this.searchChanged} value={this.state.search}/>
