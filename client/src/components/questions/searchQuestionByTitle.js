...
<div style={{border:"1px solid #000" , backgroundColor:"#E0E3E5"}} className='post bg-white p-1 my-1'>
    ...
    <div> 
      < Link to={"/question/"+props.exercise._id} >
  ...
  render() {
    return (
      <div>
        ...
        <Link to="/searchQuestionByTitle" title="Dashboard" className=''><i className="fas fa-search text-primary"></i> <span className="hide-sm text-success">By Title </span></Link>--
        <Link to="/searchQuestionByTags" title="Dashboard" className=''><i className="fas fa-search text-primary"></i> <span className="hide-sm text-dark">By Tags </span></Link>--
 

        <input  style={inputTextStyle} type='text' placeholder="Search By Title " onChange={this.searchChanged} value={this.state.search}/>
