	...
	return loading && profile === null ? (
		...
		<Fragment>
		  ...
		  Place of work 
			...
			<div className='form-group'>
            Place of work (if none of the above , write here )
           <input
            type='text'
            placeholder='if none of the above , write here'
            name='company'
            value={company}
...
<div className='form-group'>
 ...
 <select id='country' name='location' value={location} onChange={e => onChange(e)} >
