  ...
  render() {
    return (
      <div>
        ...
        <Link to="/searchPostsByName" title="Dashboard" className=''><i className="fas fa-search text-primary"></i> <span className="hide-sm text-success">By Member Name </span></Link>
        ...
        <input  style={inputTextStyle} type='text' placeholder="Type The Member Name " onChange={this.searchChanged} value={this.state.search}/>
