...
handlePageClick = (e) => {
  ...
  exerciseList() {
    ...
    .filter(post=>{
      ...
      return post.title_journal.toLowerCase().indexOf(this.state.search.toLowerCase())>=0
  ...
  render() {
    return (
      <div>
        ...
        <Link to="/searchPostsByJournal" title="Dashboard" className=''><i className="fas fa-search text-primary"></i> <span className="hide-sm text-success">By Title of Journal </span></Link>--
        ...
        {/* <Link to="/searchPostsByDate" title="Dashboard" className=''><i className="fas fa-search text-primary"></i> <span className="hide-sm text-dark">By Date </span></Link> */}

 

        <input  style={inputTextStyle} type='text' placeholder="Type Title of Journal" onChange={this.searchChanged} value={this.state.search}/>
