     ...
     <Fragment> 
       <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"> 
              ...
              <Fragment>
               ...
               <a href={`/answerCompetitionQuestion/${props.competition._id}`}  class="col-lg-12 col-md-12 col-sm-12" style={{width:'100%',backgroundColor:'#fff',textAlign:'left'}}>
               <a href={`/answerCompetitionQuestion/${props.competition._id}`}  
