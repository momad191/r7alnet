...
handlePageClick = (e) => {
  ...
  exerciseList() {
    ...
    .filter(post=>{
      ...
      return post.title_article.toLowerCase().indexOf(this.state.search.toLowerCase())>=0
  ...
  render() {
    return (
      <div>
        ...
        <Link to="/searchPostsByArticle" title="Dashboard" className=''><i className="fas fa-search text-primary"></i> <span className="hide-sm text-success">By Title of Article </span></Link>--
