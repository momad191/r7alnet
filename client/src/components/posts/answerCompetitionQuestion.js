...
<Fragment>
               ...
               <div class="form-box">
                   ...
                   <div class="form-top"   
                   style={{backgroundColor:'#363636',fontFamily:'Markazi Text', fontSize:'26px',fontWeight:'normal',color:'#fff',textAlign:'right',float:'right',padding:'5px',width:'100%',marginBottom:'60px'}}
                   >
                ...
                <a href={`/Topic/${props.competition.articleid}`}  
                   ...
                   <div class="form-bottom"  style={{backgroundColor:'#58ACFA',marginTop:'20px'}}>
...
{/* 
                  ...
                  <div style={{width:'10%',float:'right'}}>
                    <input className="form-control-radio"  type="radio" id="i1"
                    style={{backgroundColor:'#fff',color:'#000',marginBottom:'20px'}} 
                     name='answer'
                     value={props.competition.i1}
                    // onChange={this.onChangePublish}
                    />
                  </div>
                     <div className="form-control-radio"  style={{ backgroundColor:'#fff',color:'#000',width:'90%',float:'right'}} >
                     <h1 style={{ fontsize:'26px',fontFamily:'Markazi Text',color:'#000',direction:'rtl',textAlign:'right',fontWeight:'bold'}}>  {props.competition.a1}  </h1>   
                     </div>
                  </div>
                  ...
                  <div class="col-lg-12 col-md-12 col-sm-12" style={{float:'right'}}>
                  <div style={{width:'10%',float:'right'}}>
                    <input className="form-control-radio"  type="radio" id="i2"
                    style={{backgroundColor:'#fff',color:'#000',marginBottom:'20px'}} 
                     name='answer'
                     value={props.competition.i2}
                    // onChange={this.onChangePublish}
                    />
                  </div>
                     <div className="form-control-radio"  style={{ backgroundColor:'#fff',color:'#000',width:'90%',float:'right'}} >
                     <h1 style={{ fontsize:'26px',fontFamily:'Markazi Text',color:'#000',direction:'rtl',textAlign:'right',fontWeight:'bold'}}>  {props.competition.a2}  </h1>   
                     </div>
                  </div>
                  ...
                  <div class="col-lg-12 col-md-12 col-sm-12" style={{float:'right'}}>
                  <div style={{width:'10%',float:'right'}}>
                    <input className="form-control-radio"  type="radio" id="i3"
                    style={{backgroundColor:'#fff',color:'#000',marginBottom:'20px'}} 
                     name='answer'
                     value={props.competition.i3}
                    // onChange={this.onChangePublish}
                    />
                  </div>
                     <div className="form-control-radio"  style={{ backgroundColor:'#fff',color:'#000',width:'90%',float:'right'}} >
                     <h1 style={{ fontsize:'26px',fontFamily:'Markazi Text',color:'#000',direction:'rtl',textAlign:'right',fontWeight:'bold'}}>  {props.competition.a3}  </h1>   
                     </div>
                  </div>
                  ...
                  <div class="col-lg-12 col-md-12 col-sm-12" style={{float:'right'}}>
                  <div style={{width:'10%',float:'right'}}>
                    <input className="form-control-radio"  type="radio" id="i4"
                    style={{backgroundColor:'#fff',color:'#000',marginBottom:'20px'}} 
                     name='answer'
                     value={props.competition.i4}
                    // onChange={this.onChangePublish}
                    />
                  </div>
                     <div className="form-control-radio"  style={{ backgroundColor:'#fff',color:'#000',width:'90%',float:'right'}} >
                     <h1 style={{ fontsize:'26px',fontFamily:'Markazi Text',color:'#000',direction:'rtl',textAlign:'right',fontWeight:'bold'}}>  {props.competition.a4}  </h1>   
                     </div>
                  </div>
                    ...
                    <button 
                    style={{backgroundColor:'#363636',fontFamily:'Markazi Text',marginTop:'20px'}}
                    type="submit" className="momadbtn">
                     <i className='fas fa-plus' />قدم الاجابات </button>
                    </div>
...
export default class ExercisesList extends Component {
  constructor(props) {
    ...
    this.handleCorrection1 = this.handleCorrection1.bind(this);
    this.handleCorrection2 = this.handleCorrection2.bind(this);
    this.handleCorrection3 = this.handleCorrection3.bind(this);
    this.handleCorrection4 = this.handleCorrection4.bind(this);
    ...
    this.onChangechoosenAnswer = this.onChangechoosenAnswer.bind(this);
    
    this.onChangequestionid = this.onChangequestionid.bind(this);


    this.onChangetargetQuestionid = this.onChangetargetQuestionid.bind(this);
    this.onChangetargetAnswerStatus = this.onChangetargetAnswerStatus.bind(this);
    this.onChangetargetUser = this.onChangetargetUser.bind(this);
...
handleCorrection1() {
  this.setState({
    choosenAnswer: this.state.i1,
    displayButtonResult:'block'
  });
}
handleCorrection2() {
  this.setState({
    choosenAnswer: this.state.i2,
    displayButtonResult:'block'
  });
}
...
handleCorrection3() {
  this.setState({
    choosenAnswer: this.state.i3,
    displayButtonResult:'block'
  });
}
handleCorrection4() {
  this.setState({
    choosenAnswer: this.state.i4,
    displayButtonResult:'block'
  });
}
...
onChangeimage(e) {
  ...
  componentDidMount() {
    ...
    axios.get('/api/posts/topics')
      ...
      axios.get('/api/Competitions/findOneQuestion/'+this.props.match.params.id)
      .then(response => {
        this.setState({
          articleid : response.data.articleid,
          articletitle : response.data.articletitle,
          ...
          i3 : response.data.i3,
          i4 : response.data.i4,
          creatorUser:response.data.user,
        })
      })
      .catch((error) => {
        console.log(error);
      ...
      axios.get('/api/Competitions/answerCompetitionQuestion/'+this.props.match.params.id)
      .then(response => {
        this.setState({
         //articleid : response.data.articleid,
         // articletitle : response.data.articletitle,
         targetQuestionid : response.data.questionid,
         targetAnswerStatus : response.data.AnswerStatus,
         targetUser : response.data.user,
         choosenAnswer : response.data.choosenAnswer,
...
{currentSocial.Paragraph1 && (
  ...
  onChangetargetQuestionid(e) {
    this.setState({
      targetQuestionid : e.target.value
    })
  }
  onChangetargetAnswerStatus (e) {
    this.setState({
      targetAnswerStatus  : e.target.value
    })
  }
  onChangetargetUser(e) {
    this.setState({
  ...
  onSubmit(e) {
    ...
    // if(this.state.choosenAnswer=null){
    //   <h1 style={{fontFamily:'Markazi Text',fontSize:'30px',textAlign:'center',fontWeight:'bold',color:'#DF0101',direction:'rtl'}} >  لم تختر الإجابة بعد الرجاء اختيار الاجابة  </h1>
    ...
    const contact = {
      ...
      choosenAnswer: this.state.choosenAnswer,
      
   
    
    }
    axios.post('/api/Competitions/answerCompetitionQuestion/'+this.props.match.params.id,contact)
   ...
   window.location = '/answerCompetitionQuestion/'+this.props.match.params.id;
  }
...
<h1 style={{fontFamily:'Markazi Text',fontSize:'50px',textAlign:'right',fontWeight:'bold',color:'#000',direction:'rtl'}} >  {this.state.articletitle} </h1>
...
<p style={{fontFamily:' ', color:'#000',fontWeight:'bold'}}>
   ...
   <Link className='btn btn-success'
       to={`/posts/${this.state.articleid}#/${this.state.body}`}  
...
<Link className='btn btn-success'
       to={`/answerCompetitionQuestion/${this.state.questionid}`}  
       ...
       ><i  style={{fontSize:'20px'}} class="fa fa-question"></i> الأسئلة  {this.state.comments.length > 0 && (
        <span className='comment-count'>({this.state.comments.length})</span>
      )}</Link>
...
{/* {renderCompetitions} */}
 ...
 {
       this.state.targetUser!=this.state.creatorUser && this.state.targetQuestionid === this.state.questionid   ? (
        <Fragment> 
        <section id="login-reg" >
         <div class="row">
         <div class="col-lg-12 col-md-12 col-sm-12">
         ...
         <div class="col-lg-12 col-md-12 col-sm-12 form-top"   
             style={{backgroundColor:'#363636',fontFamily:'Markazi Text', fontSize:'26px',fontWeight:'normal',color:'#fff',textAlign:'right',float:'right',padding:'0px',width:'100%',marginBottom:''}}
             >  
       <h1 style={{fontFamily:'Markazi Text',fontSize:'40px',textAlign:'center',fontWeight:'bold',color:'#fff',direction:'rtl'}} >  تم حل السؤال إجابة {this.state.choosenAnswer} </h1>
       <h1 style={{fontFamily:'Markazi Text',fontSize:'30px',textAlign:'center',fontWeight:'bold',color:'#fff',direction:'rtl'}} >  شكراً  </h1>
...
<Fragment>
         ...
         <div class="col-lg-12 col-md-12 col-sm-12 form-box">
          ...
          <a href={`/Topic/${this.state.articleid}`}  
                       style={{fontFamily:'Markazi Text', fontSize:'22px',fontWeight:'normal',color:'#fff',textAlign:'right',float:'right',padding:'15px'}}
                       > {this.state.mainq} </a>  
                  
             </div>


             <div class="col-lg-12 col-md-12 col-sm-12 form-bottom"  style={{backgroundColor:'#58ACFA',marginTop:'0px',height:'',float:'right'}}>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 ">
             <a href={`/Topic/${this.state.articleid}`}  
                       style={{fontFamily:'Markazi Text', fontSize:'22px',fontWeight:'bold',color:'#000',textAlign:'right',float:'right',padding:'5px',width:'100%',marginBottom:'15px',direction:'rtl'}}
                       > اختر الإجابة الصحيحة : </a>  
             </div>
...
{/* 
            ...
            <div style={{width:'10%',float:'right'}}>
              ...
              style={{backgroundColor:'#fff',color:'#000',marginBottom:'20px'}} 
               ...
               onClick={this.handleCorrection1}
              />
            </div>
               <div className="col-lg-12 col-md-12 col-sm-12 form-control-radio"  style={{ backgroundColor:'#fff',color:'#000',width:'90%',float:'right'}} >
               <h1 style={{ fontsize:'36px',fontFamily:'Markazi Text',color:'#000',direction:'rtl',textAlign:'right',fontWeight:'bold'}}>  {this.state.a1}  </h1>   
               </div>
            </div>
            ...
            <div style={{width:'10%',float:'right'}}>
              ...
              style={{backgroundColor:'#fff',color:'#000',marginBottom:'20px'}} 
               ...
               onClick={this.handleCorrection2}
              />
            </div>
               <div className="col-lg-12 col-md-12 col-sm-12 form-control-radio"  style={{ backgroundColor:'#fff',color:'#000',width:'90%',float:'right'}} >
               <h1 style={{ fontsize:'26px',fontFamily:'Markazi Text',color:'#000',direction:'rtl',textAlign:'right',fontWeight:'bold'}}>  {this.state.a2}  </h1>   
               </div>
            </div>
            ...
            <div style={{width:'10%',float:'right'}}>
              ...
              style={{backgroundColor:'#fff',color:'#000',marginBottom:'20px'}} 
               ...
               onClick={this.handleCorrection3}
              />
            </div>
               <div className="col-lg-12 col-md-12 col-sm-12 form-control-radio"  style={{ backgroundColor:'#fff',color:'#000',width:'90%',float:'right'}} >
               <h1 style={{ fontsize:'26px',fontFamily:'Markazi Text',color:'#000',direction:'rtl',textAlign:'right',fontWeight:'bold'}}>  {this.state.a3}  </h1>   
               </div>
            </div>
            ...
            <div style={{width:'10%',float:'right'}}>
              ...
              style={{backgroundColor:'#fff',color:'#000',marginBottom:'20px'}} 
               ...
               onClick={this.handleCorrection4}
              />
            </div>
               <div className="form-control-radio"  style={{ backgroundColor:'#fff',color:'#000',width:'90%',float:'right'}} >
               <h1 style={{ fontsize:'26px',fontFamily:'Markazi Text',color:'#000',direction:'rtl',textAlign:'right',fontWeight:'bold'}}>  {this.state.a4}  </h1>   
               </div>
            </div>
            ...
            <input  style={{width:'100%',color:'#000',fontSize:'16px',fontWeight:'bold',borderColor:'#cacaca'}}  className="form-control" placeholder="" type="hidden" 
            name='choosenAnswer'  
              autocomplete="off"
              value={this.state.choosenAnswer}  
              onChange={this.onChangechoosenAnswer}
              required
              ...
              <div className="form-group">
              <button 
              style={{backgroundColor:'#363636',fontFamily:'Markazi Text',marginTop:'20px',display:`${this.state.displayButtonResult}` }}
              type="submit" className="momadbtn">
               اعتمد الإجابة </button>
              </div>
