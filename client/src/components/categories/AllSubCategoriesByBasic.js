...
<Fragment>
  ...
  <th class="text-right" style={{fontFamily:'Changa',color:'#fff',backgroundColor:'#424242',fontWeight:'bold',float:'',fontSize:'11px'}}>الاساسي</th>
  ...
  <tbody style={{borderBottom:'#000'}}>
   ...
   {/* <td>
      ...
      <Link to={`/editCategory/${props.exercise._id}`} className='btn btn-primary fontnty-font'
 ...
 <td><p  style={{ fontFamily:'Changa' ,color:"#B40486" , fontSize:"18px", fontWeight:'bold'}} className='post-date '> {props.exercise.body}</p></td> */}
  <td><p  style={{ fontFamily:'Changa' ,color:"#B40486" , fontSize:"18px", fontWeight:'bold'}} className='post-date '> {props.exercise.mainCategoryName}</p></td>

 <td>   <h5  style={{fontFamily:'Changa' , fontSize:"18px", fontWeight:'bold',color:'#0101DF'}}>  {props.exercise.subCategory} </h5> </td>
...
handlePageClick = (e) => {
  ...
  exerciseList() {
    ...
    .filter(post=>{
      ...
      return post.mainCategoryName.toLowerCase().indexOf(this.state.search.toLowerCase())>=0
  ...
  render() {
    return (
      <div>
        ...
        >  التصنيفات الفرعية   <i class="fa fa-search"></i> </h1>
        ...
        <Link to="/AllSubCategoriesByBasic" title="Dashboard" className=''
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
              ...
              autocomplete="off"
              placeholder="اكتب التصنيف الاساسي"
              />
