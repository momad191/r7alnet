...
<Fragment>
 ...
 <td>   <h5  style={{fontFamily:'Changa' , fontSize:"18px", fontWeight:'bold',color:'#0101DF'}}>  {props.exercise.text} </h5> </td>
...
handlePageClick = (e) => {
  ...
  exerciseList() {
    ...
    .filter(post=>{
      ...
      return post.body.toLowerCase().indexOf(this.state.search.toLowerCase())>=0
  ...
  render() {
    return (
      <div>
        ...
        >  البحث في التصنيفات   <i class="fa fa-search"></i> </h1>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
                    <Link to="/searchCategoryByStatus" title="Dashboard" className=''
                    ...
                    ><span  
                      >بحالة التفعيل  </span> </Link>
           
                    <Link to="/searchCategoryByTitle" title="Dashboard" className=''
