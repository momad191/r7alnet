...
<Fragment>
  ...
  <tbody style={{borderBottom:'#000'}}>
   ...
   {/* <td>
      ...
      <Link to={`/editSubCategory/${props.exercise._id}`} className='btn btn-primary fontnty-font'
...
handlePageClick = (e) => {
  ...
  componentDidMount() {
    axios.get('/api/categories/sub/'+this.props.match.params.id)
      .then(response => {
  ...
  exerciseList() {
    ...
    .filter(post=>{
      ...
      return post.subCategory.toLowerCase().indexOf(this.state.search.toLowerCase())>=0
    ...
    return (
      <div>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
              ...
              autocomplete="off"
              placeholder="اكتب التصنيف الفرعي"
              />
